...
class nevermind
{
    ...
    public function test_positions() {
        ...
        //test chaque chiffre puis passe a la position suivante lorsque goot est incr�ment�
